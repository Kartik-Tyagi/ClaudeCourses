                      ...
                      <>
                        {message.parts.map((part: any, partIndex: number) => {
                          switch (part.type) {
                            ...
                            case "dynamic-tool": {
                              const isDone = part.state === "output-available" || part.state === "output-denied";
                              return (
                                <div key={partIndex} className="inline-flex items-center gap-2 mt-2 px-3 py-1.5 bg-neutral-50 rounded-lg text-xs font-mono border border-neutral-200">
                                  {isDone ? (
                                    <>
                            ...
                            default: {
                              // Handle tool-* parts from static tools (type: "tool-{toolName}")
                        ...
                        {isLoading &&
                          ...
                          message.parts.filter((p: any) => p.type === "text" && p.text).length === 0 && (
